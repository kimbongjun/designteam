...
function wti_loginout_menu_link( $items, $args ) {	
   if ($args->menu == 'Primary') {
      if (is_user_logged_in()) {
         $items .= '<li class="right"><a href="'. wp_logout_url(get_permalink()) .'" data-hover="잘있어">'. __("잘있어") .'</a></li>';
      } else {
         $items .= '<li class="right"><a href="'. wp_login_url(get_permalink()) .'" data-hover="안녕">'. __("안녕") .'</a></li>';
      }
   }
   return $items;
}